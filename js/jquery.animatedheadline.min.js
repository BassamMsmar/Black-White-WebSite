!(function (a) {
  a.fn.animatedHeadline = function (e) {
    function n(e) {
      e.each(function () {
        var element = a(this),
          text = element.text(), // لا تقم بتقسيم النص إلى حروف
          isVisible = element.hasClass("is-visible");

        // إذا كنت لا تزال بحاجة إلى استخدام <i> أو <em> يمكنك التفاف النص بأكمله بداخلها
        var formattedText = isVisible
          ? '<i class="in">' + text + "</i>"
          : "<i>" + text + "</i>";

        // قم بإضافة النص المحدث إلى العنصر
        element.html(formattedText).css("opacity", 1);
      });
    }
    ...
    function s(a) {
      ...
      if (a.parents(".ah-headline").hasClass("type")) {
        ...
        l(a.find("i").eq(0), a, n, h.lettersDelay),
          o(i.find("i").eq(0), i, n, h.lettersDelay);
      } else
        a.parents(".ah-headline").hasClass("clip")
          ? a
              .parents(".ah-words-wrapper")
              .animate({ width: "2px" }, h.revealDuration, function () {
                d(a, i), t(i);
              })
    ...
    function t(a, i) {
      a.parents(".ah-headline").hasClass("type")
        ? (o(a.find("i").eq(0), a, !1, i),
          a.addClass("is-visible").removeClass("is-hidden"))
        : a.parents(".ah-headline").hasClass("clip") &&
          a
            .parents(".ah-words-wrapper")
            .animate({ width: a.width() + 10 }, h.revealDuration, function () {
              setTimeout(function () {
                s(a);
    ...
    this.each(function () {
      ...
      if (
        (h.animationType &&
          ("type" == h.animationType ||
          "rotate-2" == h.animationType ||
          "rotate-3" == h.animationType ||
          "scale" == h.animationType
            ? i.find(".ah-headline").addClass("letters " + h.animationType)
            : "clip" == h.animationType
            ? i
                .find(".ah-headline")
                .addClass(h.animationType + " is-full-width")
            : i.find(".ah-headline").addClass(h.animationType)),
        n(a(".ah-headline.letters").find("b")),
